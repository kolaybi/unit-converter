...
{
    public function testUnitInterfaceDefinesRequiredMethods(): void
    {
    ...
    public function testUnitCategoryHasExpectedCases(): void
    {
    ...
    public function testUnitCategoryReturnsEnumClass(): void
    {
